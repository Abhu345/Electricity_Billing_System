...
//            
            try{
               ...
               totalbill=totalbill+unit_consumed + Integer.parseInt(rs.getString("meter_rent"));
               totalbill=totalbill+unit_consumed + Integer.parseInt(rs.getString("service_charge"));
               totalbill=totalbill+unit_consumed + Integer.parseInt(rs.getString("service_tax"));
               totalbill=totalbill+unit_consumed + Integer.parseInt(rs.getString("service_tax"));
               totalbill=totalbill+unit_consumed + Integer.parseInt(rs.getString("swacch_bharat_cess"));
               totalbill=totalbill+unit_consumed + Integer.parseInt(rs.getString("fixed_tax"));
                }
            }catch(Exception e){
                e.printStackTrace();
            }
            String query2="insert into bill values('"+meter+"','"+month+"','"+units+"','"+totalbill+"','Not_Paid')";
            try{
